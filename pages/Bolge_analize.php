   ...
   <!-- Navigation -->
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">Bolge Analize</a>
            </div>
            <!-- /.navbar-header -->
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a class="active" href="Bolge_analize.php">Bolge Result Page</a>
                                </li>
                                 <li>
      ...
      <div class="row">
      		...
      		<div class="panel-body">
                <div class="table-responsive"> 
                  ...
                  <form name="testformB"  action="#" method="post">  
                				...
                				<span for="title"> Bolge:
                				  ...
                				  <?	 $sql = "SELECT BolgeAdi FROM Bolgeler";
                                        ...
                                        echo "<select name='Bolge' id='Bolge'>";?>
                					...
                					<!--span for="title">Inceleme konuler:
                					   ...
                					   <select name='konu1' id='konu1'>
                					      <option>-Konu-</option>
                					      </select-->
                		   			  </div>
                		   			  <div  class="wrapper">
                		         <!--input type='button'  value='liste gor' class="btn btn-default"  id="btnGet" /-->
                		         <button type="button" class="btn btn-default"  name="getthisB" id="getthisB">liste gor.</button>
                  	 		</div>
                  	 	</form>  
        						</div>
        					</div>
